...
$(function(){
    ...
    + "</tr></thead><tbody>";
                ...
                $.each(obj, function() {
                    result += "<tr class='text-center'><td>" + count++ + "</td><td>" + this['room_title'] + "</td><td>" + this['capacity'] + "</td><td><a class='btn btn-danger btn-sm' href='includes/delete-room.php?room_id=" + this['room_id'] + "'><i class='fa fa-trash'></i> Delete</a></td></tr>";
                });
                result += "</tbody></table>";
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data == 1){
                        ...
                        $('#room_title').val('');
                        $('#room_capacity').val('');
                        $('#addVenueModal').modal('hide'); // Bootstrap 5
