...
<head>
    <meta charset="utf-8" />
    <title>Student Login - Time Table Management System</title>
                ...
                <div class="col-lg-5 col-md-7 col-sm-9">
                    <div class="login-card">
                        ...
                        <div class="login-header">
                            ...
                            <h2>Student Login</h2>
                            <p>Access your class schedules and academic information</p>
                        </div>
                        ...
                        <div class="login-footer">
                            ...
                            <p class="help-text">Need help? <a href="#" class="support-link">Contact Student Support</a></p>
                        </div>
                    </div>
                </div>
            </div>
