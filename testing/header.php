                    ...
                    <div class="search-container">
                        ...
                        <div class="search-suggestions" id="searchSuggestions">
                            <div class="suggestion-category">
                                <h6>Quick Access</h6>
                                <a href="add-lecturer.php" class="suggestion-item">
                                    <i class="fas fa-plus"></i>Add New Lecturer
                                </a>
                                <a href="gen-time-table.php" class="suggestion-item">
                ...
                quickBtns.forEach(function(btn) {
                    btn.addEventListener('click', function(e) {
                        ...
                        if (icon.classList.contains('fa-magic')) {
                            window.location.href = 'gen-time-table.php';
            ...
            function showToast(message, type = 'info', duration = 3000) {
                ...
                if (!document.querySelector('#toast-styles')) {
                    ...
                    toastStyles.textContent = `
                            ...
                            .toast.toast-success .toast-content i { color: var(--success-color); }
                            .toast.toast-error .toast-content i { color: var(--danger-color); }
                            .toast.toast-warning .toast-content i { color: var(--warning-color); }
                        `;
